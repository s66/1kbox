var pack = (function(Global,_Packer){
/*
...
var Array___forEach=Array.prototype.forEach;//修正原型中有forEach而导致错误
...
var Undefined = K(), Null = K(null), True = K(true), False = K(false), This = function(){return Global;};
...
var Shrinker = Base.extend({
  ...
  SHRUNK:       /\x02\d+\b/g
	...
	var _pack=new Packer();
	_Packer=function(code,shrink,base62,unicode){
		code=_pack.pack(code,base62||false,shrink||false,false);
		if(unicode){
			code=code.replace(/[^\u0000-\u00FF]/g,function($0){return '\\'+escape($0).substr(1)});
		}
		return code+';\n';
	};
	//delete Global.base2;
}; ////////////////////  END: CLOSURE  /////////////////////////////////////
if(typeof Array___forEach=='function'){
	Array.prototype.forEach=Array___forEach;
	Array___forEach=null;
}
return _Packer;
})(function(){return this}());

exports.pack = function(code){
    return pack(code, 1, 0, 1); //参数对应压缩变量，base62压缩，中文装unicode压缩
};